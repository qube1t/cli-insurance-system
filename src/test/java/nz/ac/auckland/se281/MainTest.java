  ...
  public static class YourTests extends CliTest {
    ...
    public void Life_Policy_Too_Old() throws Exception {
      ...
      runCommands(
          ...
          PRINT_DB);
      assertContains("*** 1: Thanos, 101, 2 policies for a total of $108000");
      assertContains(
    ...
    public void Full_Test_1() throws Exception {
      ...
      assertContains("3: Eric, 101, 3 policies for a total of $80288");
      ...
      assertContains("9: Thanos, 101, 2 policies for a total of $108");
